...
rev_shoup_scaled_ntt1024_12289 = [
...
#             u = 2 * d * j
#             # print("\tj=%d"  % j);
#             lgt = math.log(n / d, 2) - 1

#             # w_t = pow(OMEGA, d, Q)
#             # psi_t = pow(PSI, d, Q)
#             # assert(w == (psi_t * pow(w_t, bit_rev_int(j, lgt), Q)) % Q)
...
mulntt_ct_std2rev_aug(poly, rev_shoup_scaled_ntt1024_12289)
