...
abstract module intt_impl {
    ...
    import opened intt_model

    method j_loop(a: n_sized, p: n_sized, t: pow2_t, d: pow2_t, j: nat, u: nat, ghost view: intt_loop_view)
    returns (a': n_sized)
    ...
    {
        ghost var view := build_intt_loop_view(d);
